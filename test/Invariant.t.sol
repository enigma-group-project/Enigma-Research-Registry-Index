...
contract InvariantTest is Test {
    ...
    /// @dev Authorization property: a non-Publisher can NEVER issue, for any inputs.
    function testFuzz_OnlyTestCenterCanIssue(address caller, bytes32 id, bytes32 h, address owner_) public {
        ...
        vm.assume(!issuers.isPublisher(caller));
        vm.prank(caller);
        vm.expectRevert(RecordRegistry.NotPublisher.selector);
        records.registerDataset(id, h, "cid", owner_, "meta");
    }
